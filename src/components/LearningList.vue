<template>
  <div
    class="grid grid-rows-2 justify-center gap-10 text-slate-100 p-8 font-semibold bg-[#162234] max-h-[350px] rounded-t-xl -mt-8 border-t-2 border-[#155b26] hide-el text-xs sm:text-sm overflow-scroll overflow-x-hidden md:overflow-auto"
    id="el-learning"
  >
