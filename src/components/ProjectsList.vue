<template>
  ...
  >
    <project-card
      ...
      prjImg="src/assets/project-ss/local-crime.webp"
      prjNo="1"
    ...
    <project-card
      ...
      prjImg="src/assets/project-ss/book-collection.webp"
      prjNo="2"
    ...
    <project-card
      ...
      prjImg="src/assets/project-ss/ecoelectronics.webp"
      prjNo="3"
    ...
    <project-card
      ...
      prjImg="src/assets/project-ss/fullstack-forum.webp"
      prjNo="4"
    ...
    <project-card
      ...
      prjImg="src/assets/project-ss/coach-finder.webp"
      prjNo="5"
    ...
    <project-card
      ...
      prjImg="src/assets/project-ss/portfolio.webp"
      prjNo="6"
      prjName="Portfolio"
...
export default {
  ...
  data() {
    return {
      prj1Res: ["HTML5", "CSS", "JavaScript", "Vue"],
      prj2Res: ["HTML5", "CSS", "JavaScript", "Vue"],
      prj3Res: ["HTML5", "CSS", "JavaScript", "Vue"],
      prj4Res: ["NodeJs", "ExpressJs", "MongoDb", "Pug"],
      prj5Res: ["HTML5", "CSS", "JavaScript", "Vue"],
